...
python Variants_vs_FPKM_ACTB.py -s ../Sample_Data/ -c "chr7:5527152-5563902"
"""
#%% Imports
...
plt.title("Variant Counts/FPKM for ACTB")
plt.savefig("Variants_vs_FPKM_ACTB.png")
