...
python Variants_vs_FPKM_EGFR.py -s ../Sample_Data/ -c "chr7:55015425-55293487"
"""
#%% Imports
...
plt.title("Variant Counts/FPKM for EGFR")
plt.savefig("Variants_vs_FPKM_EGFR.png")
