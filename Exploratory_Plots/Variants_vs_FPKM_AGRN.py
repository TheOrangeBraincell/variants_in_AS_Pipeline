...
python Variants_vs_FPKM_AGRN.py -s ../Sample_Data/ -c "chr1:1020120-1056116"
"""
#%% Imports
...
plt.title("Variant Counts/FPKM for AGRN")
plt.savefig("Variants_vs_FPKM_AGRN.png")
