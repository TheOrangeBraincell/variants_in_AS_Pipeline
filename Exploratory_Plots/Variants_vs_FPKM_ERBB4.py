...
python Variants_vs_FPKM_ERBB4.py -s ../Sample_Data/ -c "chr2:211383615-212538530"
"""
#%% Imports
...
plt.title("Variant Counts/FPKM for ERBB4")
plt.savefig("Variants_vs_FPKM_ERBB4.png")
