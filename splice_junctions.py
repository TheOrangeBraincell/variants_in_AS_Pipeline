...
"""
date: 07-04-22
title: splice_junctions.py
author: Mirjam Karlsson-Müller

Description:
    Finds splice junctions in a bam file, then compares found splicejunctions
    to annotated splicejunctions (GENCODE) and returns a .bed file, which
    is colourcoded for splicejunctions found in the reads and database, or in
    just oen of the two.


Instructions:
    Run in command line. Requires GENCODE database file, containing annotated
    exons.
...
Possible Bugs:
    - If there is no .bai file for the .bam file, then the bam file cannot be
